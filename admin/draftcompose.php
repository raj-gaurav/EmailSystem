...
<?php
	...
	$did=$_REQUEST['id'];
	$get="select * from `draft` where `id`='$did'";
				...
				<form action="#" method="post">
					<table class="table table-border">
						<tr style="">
							...
							<td colspan="2"><a href="draft.php"><input type="button"  value="Back" class="btn btn-primary" /></a></td>
						</tr>
						...
						<tr>
							<th>To :&nbsp;&nbsp; </th>
							<td><input type="email" name="receiver" required="required" value="<?php echo $ddata[3]; ?>" style=" width:375px; border:none; border-bottom: 1px solid #000; outline: none; background: transparent;"/><br><br></td>
						</tr>
						<tr>
							<th>Subject :&nbsp;&nbsp; </th>
							<td><input type="text" name="subject"  value="<?php echo $ddata[4]; ?>" style=" width:375px; border:none; border-bottom: 1px solid #000; outline: none; background: transparent;"/><br><br></td>
						</tr>
