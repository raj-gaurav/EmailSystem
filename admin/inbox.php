	...
	<div class="right  " style="float:left; height:86%;width:80%;z-index=1;background-color:#c0c0c0;overflow:hidden; ">
		<div style=" height:100%; width:100%; overflow:hidden; ">
			...
			<div class="row bg-dark mb-1" style=" padding-left:5px; ">
				<div class="col-3 text-white  ">Mail from</div>
				<div class="col-2 text-white">Date & Time</div>
			...
			<?php
				$email=$data['email'];
				$q2="select * from `inbox` where `receiver`='$email'";
			...
			<div class="row bg-white mb-1 pb-1 pt-1" style=" padding-left:5px; border:2px solid #dc3545; border-radius:20%; ">
				...
				<div class="col-5 "><?php echo "$fetch[5]" ;?></div>
				<div class="col-2 " style="text-align:center;"><a href="read.php?<?php echo "id=$fetch[0] & x=0";?>">Read</a> | <a href="delete.php? <?php echo "id=$fetch[0] & x=0"; ?> " onclick="return confirm('Are you sure ?');">Delete</a></div>
