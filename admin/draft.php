...
<div>
	...
	<div class="right " style="float:left; height:86%;width:80%;z-index=1; background-color:#c0c0c0;overflow:hidden; ">
		<div style=" height:100%; width:100%;overflow:hidden;  ">
			...
			<?php
				$email=$data['email'];
				$q2="select * from `draft` where `sender`='$email'";
			    ...
			    while($fetch=mysqli_fetch_row($exec))
				{
					...
					<div class="row bg-white mb-1 pb-1 pt-1" style=" padding-left:5px; border:2px solid #dc3545; border-radius:20%; ">
						...
						<div class="col-2 " style="text-align:center;"><a href="draftcompose.php?<?php echo "id=$fetch[0]" ; ?>">Edit</a> | <a href="delete.php? <?php echo "id=$fetch[0] & x=2"; ?>"  onclick="return confirm('Are you sure ?');">Delete</a></div>
