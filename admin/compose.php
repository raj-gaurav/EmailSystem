...
<div>
	...
	<div class="left bg-danger" style="float:left; height:86%;width:20%; z-index=3;">
		...
		<script>
			document.getElementById('compose').style.color='black';
		</script>
	</div>
			...
			<div class="container" style="margin-top:50px; margin-left:50px;"/>
				<form action="#" method="post">
					<table class="table table-border">
						...
						<tr>
							<th>Subject :&nbsp;&nbsp; </th>
							<td><input type="text" name="subject"  style=" width:375px; border:none; border-bottom: 1px solid #000; outline: none; background: transparent;"/><br><br></td>
						</tr>
