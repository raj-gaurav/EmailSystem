...
<?php
	...
	{
		$get="select * from `outbox` where `id`='$did'";
		$drun=mysqli_query($con,$get);
		$ddata=mysqli_fetch_row($drun);
	}
?>
			...
			<div class="container" style="margin-top:50px; margin-left:50px;"/>
				<form action="#" method="post">
					<table class="table table-border">
						...
						<tr>
							<th>To :&nbsp;&nbsp; </th>
							<td><input type="email" name="receiver" required="required"  style=" width:375px; border:none; border-bottom: 1px solid #000; outline: none; background: transparent;" /><br><br></td>
						</tr>
						<?php
							if($_REQUEST['x']==0)
							{
						...
						<tr>
							<th>Subject :&nbsp;&nbsp; </th>
							<td><input type="text" name="subject"  value="Fwd : <?php echo $ddata[5]; ?> :" style=" width:375px; border:none; border-bottom: 1px solid #000; outline: none; background: transparent;"/><br><br></td>
						</tr>
						...
						<?php 
							...
							else if($_REQUEST['x']==1)
							{
								...
								<tr>
									<th>Subject :&nbsp;&nbsp; </th>
									<td><input type="text" name="subject"  value="Fwd : <?php echo $ddata[4]; ?> :" style=" width:375px; border:none; border-bottom: 1px solid #000; outline: none; background: transparent;"/><br><br></td>
								</tr>
